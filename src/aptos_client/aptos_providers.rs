...
impl Provider {
    pub fn url(&self) -> &str {
        match self {
            ...
            Provider::Devnet => "https://api.devnet.aptoslabs.com",
            Provider::Testnet => "https://api.testnet.aptoslabs.com",
            Provider::Mainnet => "https://api.mainnet.aptoslabs.com",
            Provider::Custom(url, _ws_url) => url,
        }
    }
    pub fn ws_url(&self) -> &str {
        match self {
            ...
            Provider::Devnet => "wss://api.devnet.aptoslabs.com",
            Provider::Testnet => "wss://api.testnet.aptoslabs.com",
            Provider::Mainnet => "wss://api.mainnet.aptoslabs.com",
